...
public class OngoingFragment extends Fragment {
    ...
    //method utk menginisiasi seluruh object yang ada pada halaman ini
    private void initialize(){
        ...
        //proses utk mengambil data user berupa produk apa yang sedang proses transaksi
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.getChildrenCount()!=0){
                    ...
                    for (DataSnapshot dats:dataSnapshot.getChildren()){
                        if (dats.child("status").getValue().toString().equalsIgnoreCase("active")){
                            status=true;
                            tv_item_empty.setVisibility(View.GONE);
    ...
    private void initRecyclerViewItem(){ // fungsi buat bikin object list ongoing item
        rv_item = getActivity().findViewById(R.id.rv_item);
        adapter = new OngoingAdapter(mList,getActivity().getApplicationContext(),getActivity());
