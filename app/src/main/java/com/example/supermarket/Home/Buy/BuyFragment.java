...
public class BuyFragment extends Fragment {
    ...
    private void initiliaze(){
        ...
        //proses mengambil data user berupa notif, apakah ada notif yg belum dibaca oleh user atau tidak
        ...
        //proses pengecekan, apakah recycler view sudah siap tampil atau belum
        ...
        //kondisi utk mengecek apakah user sedang mencari sesuatu atau tidak
            ...
            productRefs.orderByChild("nama_produk").startAt(searchText).addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    if (dataSnapshot.getChildrenCount()!=0){
                        ...
                        mList.clear();
                        reverse.clear();
                        //proses utk mengambil product yang ada pada firebase database dan ditampilkan ke dalam recycler view
    ...
    //mwthod utk menampilkan produk sesuai dengan kondisi yang ada pada filter
    ...
    //method utk menampilkan produk sesuai dengan kategori yang ada pada filter
    ...
    //method utk menampilkan produk sesuai dengan price yang ada pada filter
