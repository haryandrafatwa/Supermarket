...
public class EnterAmountFragment extends Fragment {
    ...
    private void initialize(){
        ...
        editText.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                //kondisi ketika card view ditekan, maka edit text amount akan terisi sesuai isi card view
                switch (s.toString()){
                    case "$5" :
            ...
            public void afterTextChanged(Editable s) {
                //proses utk mengubah menjadi format USD
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(!editText.getText().toString().equals("")){
                    //kondisi utk pengecekan apakah amount lebih besar dari 5 atau tidak
                    if(Integer.valueOf(editText.getText().toString().replaceAll("[$,]",""))<5){
                        ...
                        //pindah ke halaman choose payment method dengan mengirimkan objek yang berisi variabel amount
    ...
    //method utk pinda-pindah halaman menggunakan fragment
