...
public class ConfirmationFragment extends Fragment {
    ...
    private void initialize(){
        ...
        //proses mengambil data user berupa saldo yg dimiliki user, dan ditampung di variabel saldo
        ...
        //proses pengambilan data transaksi yang sedang berlangsung oleh suatu user, jika ada status waiting, maka seluruh data transaksi tersebut diambil dan ditampung di variabel local
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot dsp : dataSnapshot.getChildren()){
                    if(dsp.child("status").getValue().toString().equals("Waiting")) {
                        ...
                        //kondisi utk menampilkan icon bank sesuai dengan pilihan user
                        ...
                        //proses utk memulai timer utk melakukan konfirmasi ke firebase database
                        ...
                        marketRefs.child(id).addValueEventListener(new ValueEventListener() {
                            @Override
                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                //proses pengambilan data transaksi dan melakukan pengecekan, apakah transaksi dengan id sekian telah selesai melakukan transaksi, jika selesai, timer akan berhenti
    ...
    //method utk memulai timer dan juga menampilkan ke text view yg ada pada halaman ini
    ...
    //method utk melakukan stop timer ketika transaksi selesai, dan menampilkan pesan dialog
    ...
    //method utk menampilkan pesan dialog berupa saldo yang dimiliki user setelah transaksi beserta keterangan transaksi berhasil atau tidak
