...
public class CartDetailAdapter extends RecyclerView.Adapter<CartDetailAdapter.ViewHolder> {
    ...
    //method utk menentukan layout yg akan dijadikan item layout
    @Override
    ...
    public void onBindViewHolder(final ViewHolder viewHolder, int i) {
        ...
        //proses ketika melakukan delete product
    ...
    //method utk menampilkan pesan dialog apabila ingin mendelete product
    ...
    //class utk menampung objek2 yang ada pada halaman item layout
